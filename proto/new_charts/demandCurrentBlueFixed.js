...
var ctx = document.getElementById("demandCurrentBlueFixed");
        ...
        datasets: [
            {
                ...
                datalabels: {
                    ...
                    formatter: function(value, context) {
                        return 'Cont. P: ' + new Intl.NumberFormat('pt-BR').format(value);  
                    }
                }
            },
            {
                ...
                datalabels: {
                    ...
                    formatter: function(value, context) {
                        return 'Cont. FP: ' + new Intl.NumberFormat('pt-BR').format(value);  
                    }
                }
            },
            {
            ...
            },
            {
                ...
                data: [328.86, 335.16, 419.50, null, 375.48, 349.02, 244.44, 284.76, 454.86, 471.24, 506.52, 599.99],
